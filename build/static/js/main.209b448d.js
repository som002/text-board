/*! For license information please see main.209b448d.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, t, n) => {
        ...
        function ui(e, t, n, r) {
          ...
          "object" === typeof l && null !== l
            ? (a.context = zl(l))
            : ((l = Ra(t) ? za : Pa.current), (a.context = La(e, l))),
        ...
        function Ni(e, t, n, r, a) {
          ...
          if ((Tl(t, a), null === t.stateNode))
            ...
            (o.state = f),
              $l(t, r, o, a),
              (u = t.memoizedState),
              i !== r || f !== u || Ta.current || Fl
                ? ("function" === typeof c &&
                    (ri(t, n, c, r), (u = t.memoizedState)),
                  (i = Fl || li(t, n, i, r, f, u, s))
                    ? (d ||
            ...
            i !== d || f !== h || Ta.current || Fl
              ? ("function" === typeof p &&
                  (ri(t, n, p, r), (h = t.memoizedState)),
                (s = Fl || li(t, n, s, r, f, h, u) || !1)
                  ? (c ||
        ...
        function as(e, t) {
          ...
          if (0 !== t) {
            if (
              ...
              throw ((n = Fu), fs(e, 0), is(e, r), rs(e, Ge()), n);
            if (6 === t) is(e, r);
            else {
              if (
        ...
        function vs(e, t) {
          ...
          if ((_l(), (Pu = n), (Cu.current = r), null !== zu))
            throw Error(l(261));
        ...
        function js(e, t, n, r, a, o) {
          ...
          if (((r = e), "function" === typeof e)) Rs(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case z:
                return (
                  ((e = Ls(19, n, t, a)).elementType = z), (e.lanes = o), e
                );
              case O:
                return Ms(n, a, o, t);
              default:
  ...
  (n.m = e),
    ...
    (n.u = (e) => "static/js/" + e + ".e24d241d.chunk.js"),
    (n.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self.webpackChunktextFormatter =
          self.webpackChunktextFormatter || []);
  ...
  function g(e, t, n, a) {
    ...
    function y() {
      ...
      let e = g(),
        t = null == e ? null : e - v;
      (v = e), f && f({ action: u, location: w.location, delta: t });
    }
    function b(e) {
      let t =
    ...
    let w = {
      ...
      replace: function (e, t) {
        ...
        let l = p(a, v),
          s = w.createHref(a);
        i.replaceState(l, "", s),
          o && f && f({ action: u, location: w.location, delta: 0 });
      },
      go: (e) => i.go(e),
    };
    return w;
  ...
  function w(e, t, n, r) {
    let a = j(("string" === typeof t ? v(t) : t).pathname || "/", n);
    ...
    void 0 === r && (r = !1),
      "string" === typeof e
        ...
        : ((a = s({}, e)),
          ...
          d(!a.search || !a.search.includes("#"), F("#", "search", "hash", a)));
    let l,
      o = "" === e || "" === a.pathname,
      i = o ? "/" : a.pathname;
    if (null == i) l = n;
  ...
  function ee() {
    return Z() || d(!1), a.useContext(X).location;
  }
  function te(e) {
  ...
  function Se(e, t) {
    ...
    return (
      a.Children.forEach(e, (e, r) => {
        ...
        e.type !== be && d(!1), e.props.index && e.props.children && d(!1);
        let o = {
  ...
  var Oe = n(579);
  function je(e) {
    let { title: t, about: n, mode: r, toggleMode: a } = e;
    return (0, Oe.jsxs)(Oe.Fragment, {
      children: [
        (0, Oe.jsx)("nav", {
          className: `navbar navbar-expand-lg bg-${r} navbar-${r}`,
          children: (0, Oe.jsxs)("div", {
            className: "container-fluid",
            children: [
              (0, Oe.jsx)("a", {
                className: "navbar-brand",
                href: "/textFormat-Tool",
                children: t,
              }),
              (0, Oe.jsx)("button", {
        ...
        (0, Oe.jsx)("div", {
          ...
          children: (0, Oe.jsxs)("div", {
            className:
              "form-check form-switch d-flex justify-content-sm-end my-2",
            children: [
              (0, Oe.jsx)("input", {
              ...
              (0, Oe.jsx)("label", {
                className:
                  "form-check-label text-" + ("light" === r ? "dark" : "light"),
                htmlFor: "darkMode",
                children: "light" === r ? "DarkMode" : "LightMode",
              }),
            ],
          }),
        }),
  ...
  function Fe(e) {
    let { heading: t = "{text heading}", mode: n, showAlert: r } = e;
    const [l, o] = (0, a.useState)("");
    function i() {
      switch ((document.getElementById("myBox").focus(), this)) {
        case "upper":
          o(l.toUpperCase()), r("Uppercase Applied", "info");
          break;
        case "lower":
          o(l.toLowerCase()), r("Lowercase Applied", "info");
          break;
        case "whiteSpace":
          o(l.replace(/\s+/gi, " ")), r("Extra WhiteSpaces Removed", "info");
          break;
        case "clear":
          o(""), r("TextField Cleared", "danger");
          break;
        case "download":
          !(function (e) {
            const t = document.getElementById("download"),
              n = document.createAttribute("disabled");
            t.setAttributeNode(n), console.log(e);
            let r = new Blob([e], { type: "text/plain" });
            const a = document.createElement("a");
            (a.href = URL.createObjectURL(r, { encoding: "utf8" })),
              (a.download = "text_1.txt"),
              a.click(),
              setTimeout(() => {
                t.removeAttributeNode(t.getAttributeNode("disabled")),
                  console.log("enabling download");
              }, 3e3);
          })(l),
            r("File Downloaded \u2b07\ufe0f", "success");
          break;
        case "copy":
          !(async function () {
            const e = document.getElementById("myBox");
            try {
              ...
              r(`Failed to copy text:  ${t}`, "danger"),
                console.error("Failed to copy text: ", t);
            }
          })(),
            r("Text copied to clipboard", "info");
          break;
        default:
          console.error("Invalid Error"), r("An Error Occurred", "danger");
      }
    }
    return (0, Oe.jsxs)(Oe.Fragment, {
      children: [
        (0, Oe.jsx)("h1", {
          className: "text-" + ("light" === n ? "dark" : "white"),
          children: t,
        }),
        (0, Oe.jsxs)("div", {
          className: "mb-3",
          children: [
            ...
            (0, Oe.jsx)("textarea", {
              ...
              title: 0 === l.length ? "write something" : "select text to copy",
              type: "text",
        ...
        (0, Oe.jsxs)("div", {
          className: "d-flex p-2 justify-content-sm-center flex-wrap",
          children: [
            (0, Oe.jsx)("button", {
              className: "btn btn-primary mx-2 my-1",
              onClick: i.bind("upper"),
              children: "UPPERCASE",
            }),
            (0, Oe.jsx)("button", {
              className: "btn btn-secondary mx-2 my-1",
              onClick: i.bind("lower"),
              children: "Lowercase",
            }),
            (0, Oe.jsx)("button", {
              className: "btn btn-secondary mx-2 my-1",
              onClick: i.bind("whiteSpace"),
              children: (0, Oe.jsx)("b", { children: "Extra whiteSpace" }),
            }),
            (0, Oe.jsx)("button", {
              className: "btn btn-danger mx-2 my-1 ",
              onClick: i.bind("clear"),
              children: (0, Oe.jsx)("i", { children: "Clear" }),
            }),
            (0, Oe.jsx)("button", {
              className: "btn btn-outline-success mx-2 my-1 ",
              onClick: i.bind("copy"),
              children: (0, Oe.jsx)("i", { children: "Copy" }),
            }),
            (0, Oe.jsx)("button", {
              className:
                "btn btn-primary mx-2 my-1 py-2 text-md-start text-center",
              id: "download",
              onMouseUp: i.bind("download"),
              children: (0, Oe.jsx)("b", { children: "\u21e9" }),
            }),
          ],
        }),
        (0, Oe.jsxs)("div", {
          className: "container text-" + ("light" === n ? "dark" : "light"),
          children: [
            (0, Oe.jsx)("h1", { children: "Your text summary" }),
            (0, Oe.jsxs)("p", {
              children: [
                0 === l.length ? 0 : l.trim().split(" ").length,
                " ",
                l.trim().split(" ").length > 1 ? "words" : "word",
                " ",
                "and ",
                l.length,
                " characters",
            ...
            (0, Oe.jsxs)("p", {
              children: [
                0 === l.length ? 0 : 0.218 * l.trim().split(" ").length,
                " seconds read",
              ],
            }),
            (0, Oe.jsx)("h2", { children: "Preview" }),
            (0, Oe.jsx)("p", {
              className: "text-secondary bg-light p-1",
              children:
                l.length > 0 ? l : "Write something to view the preview",
            }),
          ],
        }),
      ],
  ...
  function Me() {
    const [e, t] = (0, a.useState)({
      ...
      [n, r] = (0, a.useState)("Enable Dark Mode");
    return (0, Oe.jsxs)("div", {
      className: "container",
      children: [
        (0, Oe.jsxs)("div", {
          className: "form-check form-switch d-flex justify-content-sm-end",
          children: [
            (0, Oe.jsx)("input", {
              className: "form-check-input mx-2",
              type: "checkbox",
              ...
              onClick: () => {
                "#052c65" === e.color
                  ? (t({ color: "#fff", backgroundColor: "#222" }),
                    r("Enable Light Mode"))
                  : (t({ color: "#052c65", backgroundColor: "#cfe2ff" }),
                    r("Enable Dark Mode"));
              },
            }),
            (0, Oe.jsx)("label", {
                  ...
                  (0, Oe.jsx)("div", {
                    ...
                    children: (0, Oe.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, Oe.jsx)("code", { children: ".accordion-body" }),
  ...
  function De(e) {
    return (
      e.alert &&
      (0, Oe.jsxs)("div", {
        className: `alert alert-${e.alert.type} alert-dismissible fade show border border-2 border-light top-0 start-50 translate-middle-x position-absolute `,
        role: "alert",
        children: [
          (0, Oe.jsx)("strong", {
            children:
              e.alert.type.charAt(0).toUpperCase() +
              e.alert.type.slice(1).toLowerCase(),
          }),
          ":",
          e.alert.msg,
          (0, Oe.jsx)("button", {
  ...
  je.defaultProps = { title: "set title", about: "About section goes here" };
  const Ie = (function () {
    let e,
  ...
  const Ue = function () {
      ...
      return (0, Oe.jsx)(Oe.Fragment, {
        children: (0, Oe.jsxs)(Ne, {
          children: [
            (0, Oe.jsx)(je, {
              title: "textFormatter",
              about: "About textFormatter",
              mode: e,
              toggleMode: () => {
                if ("light" === e)
                  return (
                    ...
                    void l("Dark mode enabled", "success")
                  );
                t("light"),
                  (document.body.style.backgroundColor = "#f0f0f0c9"),
                  l("Dark mode disabled", "info");
              },
            }),
            (0, Oe.jsxs)("div", {
  ...
  o
    ...
    .render((0, Oe.jsx)(a.StrictMode, { children: (0, Oe.jsx)(Ue, {}) })),
    Ae();
})();
//# sourceMappingURL=main.209b448d.js.map
